<?php
/**
 * tag_scripture_time.php: Modification of tag_scripture.php to run timed
 *   tests of regex and replacement on a static text.
 */
          ...
          (?|
               (?i:<span[^>]+
                   ...
                   [^>]*>      # Anything until the close of the tag
                     (.*?)     # Everything until the next <\/span>, non-greedy
